    ...
    <div class="table-container">
      <el-table ref="adminTable"
        ...
        <el-table-column label="出生日期" align="center">
          <template slot-scope="scope">{{scope.row.dateOfBirth | formatDateTime }}</template>
        </el-table-column>
        ...
        <el-table-column label="入学日期" align="center">
          <template slot-scope="scope">{{scope.row.enrollmentDate | formatDateTime}}</template>
        </el-table-column>
...
<script>
import { fetchList} from '@/api/fms/students/students';
